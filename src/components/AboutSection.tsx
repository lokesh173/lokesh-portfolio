...
const ABOUT_TEXT =
  "I'm Taarapareddy Lokesh Reddy, a B.Tech Computer Science Engineering student at Vikas Group of Institutions, Vijayawada — graduated in 2026. I specialize in Python backend development and full-stack web applications. With hands-on internship experience at VXL IT Solutions and MS Square Technologies, I've built real-world systems powering dynamic web interfaces and scalable REST APIs.";
          ...
          <FadeIn delay={0.15} className="w-full max-w-3xl">
            <div className="flex flex-col gap-5 sm:gap-6">
              {[
                ...
                { label: 'Frameworks', items: ['Flask', 'HTML', 'CSS', 'Bootstrap'] },
                { label: 'Databases', items: ['MySQL', 'SQLite'] },
                { label: 'Tools', items: ['Git', 'GitHub', 'Postman', 'VS Code', 'Linux CLI'] },
                { label: 'Concepts', items: ['REST APIs', 'OOP', 'CRUD', 'DBMS', 'Data Structures', 'Agile'] },
              ].map((group) => (
